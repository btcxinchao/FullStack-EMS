    ...
    <div className='animate-fade-in'>
       ...
       <div className='grid grid-cols-1  gap-4 sm:grid-cols-3 sm:gap-5 mb-8'>
        {cards.map((card,index)=>{
           return  <div key={index} className='card card-hover p-5 sm:p-6 
            relative overflow-hidden group flex items-center justify-between'>
                ...
                <card.icon className='size-12 p-2.5 rounded-lg bg-slate-100 text-slate-600 
       ...
       <div className="flex flex-col sm:flex-row gap-3">
        ...
        items-center justify-center gap-2"> Mark Attendance <ArrowRightIcon className="w-4 h-4"/></Link>
