      ...
      <div className="relative aspect-4/3 w-full overflow-hidden bg-linear-to-br from-slate-100 to-slate-50 ">
        ...
        <div className="absolute top-3 left-3 flex gap-2 ">
          <span
            ...
            px-2.5 py-1 text-xs font-semibold  text-slate-600 rounded-lg shadow-sm"
          >
        ...
        {!employee.isDeleted && (
          <div
            className="absolute inset-0 bg-linear-to-t from-indigo-700/20 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex items-end justify-center pb-6 gap-3
"
          >
