...
import { PalmtreeIcon, ThermometerIcon, Umbrella, PlusIcon } from "lucide-react";
import LeaveHistory from "../components/leave/LeaveHistory";
import ApplyLeaveModals from "../components/leave/ApplyLeaveModals";
...
const Leave = () => {
  ...
  const fetchLeaves = useCallback(() => {
    setLeaves(dummyLeaveData); // ✅ set dữ liệu giả lập
    setTimeout(() => {
      setLoading(false);
    }, 1000);
  }, []);
  ...
  return (
    <div className="animate-fade-in">
      ...
      <ApplyLeaveModals open={showModal} onClose={()=> setShowModal(false)} onSuccess={fetchLeaves} />
    </div>
